package Collections2Task2;
/*
Реализуйте итератор по двум итератором
 */
import java.util.*;

class IteratorforIterators<T> implements Iterator<T> {

    private Iterator<T> iterator1;
    private Iterator<T> iterator2;

    public IteratorforIterators (Iterator<T> iterator1, Iterator<T> iterator2) {
