...
public class Bot extends TelegramLongPollingBot {
    ...
    */
    static String botToken = "1404162519:AAHJQfNxJxPX9n-I0huunAZeyjIDGyLJVBk";
        ...
        while (true) {
            ...
            if ((hourNow == 1) && (minuteNow == 48)) {
                ...
                for (int i = 0; i < userAlertsList.size(); i++) {
                    ...
                    String weatherString = Weather.getWeatherNow(currentUserCity, model);
    ...
    */
    public void setButtons(SendMessage sendMessage) {
        ...
        keyboardSecondRow.add(new KeyboardButton("Погода сейчас"));
        keyboardThirdRow.add(new KeyboardButton("Москва"));
        keyboardThirdRow.add(new KeyboardButton("Париж"));
    ...
    */
    ...
    //Имя бота
    @Override
    public String getBotUsername() {return "FromOlgaWeatherBot";}
    //Токен бота
