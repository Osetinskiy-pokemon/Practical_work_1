...
public class Person {
    private StringProperty firstName; //мы работаем с ними, потому что это наблюдаемый объект.
    private StringProperty lastName; //любой тип данных типа Property - наблюдаемый объект.
